...
# manuscripts faithfully (including the strange Roman numeral convention and the
# missing fitt and lines)
...
# Commented out code for reference - this was used to generate the FITT_BOUNDARIES
# number_markers = {}
# offset = 0
